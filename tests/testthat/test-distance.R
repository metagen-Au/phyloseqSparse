...
treeFile = system.file("extdata", "GP_tree_rand_short.newick.gz", package="phyloseqSparse")
GP500File = system.file("extdata", "GP_otu_table_rand_short.txt.gz", package = "phyloseqSparse")
...
gp500_uuf = read.csv(system.file("extdata", "gp500-uuf.csv", package = "phyloseqSparse"), header = FALSE, fill = TRUE)
gp500_wuf = read.csv(system.file("extdata", "gp500-wuf.csv", package = "phyloseqSparse"), header = FALSE, fill = TRUE)
